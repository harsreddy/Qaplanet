...
public class VtigerProducts
{
	public static void main(String[] args)throws Exception
	{
		...
		//Create webelements for Calendar
				...
				if(Driver.getTitle().equals("user1 - Products - vtiger CRM 5 - Commercial Open Source CRM"))
				{
				...
				//create webelement for Create Product
				WebElement objCreateProduct=Driver.findElement(By.xpath("/html/body/table[3]/tbody/tr[2]/td[2]/table/tbody/tr/td[2]/table/tbody/tr/td/table/tbody/tr/td[1]/a/img"));
				//click on Create Product
				objCreateProduct.click();
				//wait 2 sec
				Thread.sleep(2000);
				//verify Creating New Product page must be displayed
				if(Driver.findElement(By.xpath("/html/body/table[4]/tbody/tr/td[2]/form/div/span")).getText().equals("Creating New Product"))
				{
					System.out.println("Creating New Product page displayed");
				}
				else
				{
					System.out.println("Failed to display");
				...
				if(A.getText().equals("Product Name cannot be empty"))
				{
					...
					//to enter name
					String sp="Selenium"+d;
					Driver.findElement(By.name("productname")).sendKeys(sp);
				//---------------------------------------------------------------------------
				//Click on save
				objSave.click();
				//wait for 2 sec
				Thread.sleep(2000);
				//verify Product Information page must be displayed
				if(Driver.findElement(By.xpath("/html/body/table[3]/tbody/tr/td/table[2]/tbody/tr/td[2]/div/table[1]/tbody/tr/td/span[1]")).getText().contains("Product Information"))
				{
				...
				//================================================================================================
				//to get id
				String sid1=Driver.findElement(By.xpath("//*[@id='tblProductInformation']/table/tbody/tr[1]/td[4]")).getText();
				System.out.println(sid1);
				Thread.sleep(1000);
				//Click on Products 
				Driver.findElement(By.linkText("Products")).click();
				//verify Products module page displayed
				if(Driver.findElement(By.xpath("/html/body/table[3]/tbody/tr[2]/td[1]/a")).getText().equals("Products"))
				{
					System.out.println("Products Module page displayed");
				}
				//wait 2 sec
				Thread.sleep(2000);
				//==========================================================================================
				...
				Thread.sleep(2000);
				//verify Editing Product Information page displayed
				if(Driver.findElement(By.xpath("/html/body/table[4]/tbody/tr/td[2]/div/span")).getText().contains("Editing Product Information"))
				{
					System.out.println("Editing Product Information page is displayed");
				}
				//wait 2 sec
				Thread.sleep(2000);
				//to clear data
				...
				//-------------------------------------------------------------------
				//to enter new values
				Driver.findElement(By.name("productname")).sendKeys(sp1);
				Thread.sleep(2000);
				//Create webelement
